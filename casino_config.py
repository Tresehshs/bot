...
bot = telebot.TeleBot('5986173849:AAFFWB7Rd0rFGNxQOIHq6PX5QF8nzyaRnWc') # токен казино
db = database



support = '@MACTEP_CHIEF' # @username саппорта по казино
chat_workers = -1583180279 # ID чата воркеров
chat_channel = -1583180279 # ID канала залетов
id_bot = 5986173849 # ID бота казино
