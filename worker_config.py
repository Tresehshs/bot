...
bot = telebot.TeleBot('5868228436:AAHYcjZlAND67MbO92rgzyEHUrSk3WVFQkY') # Токен воркер бота
db = database
...
admin = [5745512040,5505442533] # ID Админов
chat_channel = 1583180279 # ID Канала с залетами 
id_bot = 5868228436 # ID Worker бота
casino = 'SPEED_CASINO_RUBOT' # Username Casino бота
url_info_channel = 'https://t.me/+9DdT4ppdeMhmZmZi' # Ссылка на инфо канал
url_payments_channel = 'https://t.me/+9DdT4ppdeMhmZmZi' # Ссылка на канал залетов
date_open = '01  Февраля 2023' # дата открытия проекта
date_open_cc = '01.02.2023' # дата с указанным месяцем цифрой 
url_admin = '@MACTEP_CHIEF' # username ТСа (можно через ',' несколько)
